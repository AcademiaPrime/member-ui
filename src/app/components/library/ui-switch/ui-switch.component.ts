...
export class UiSwitchComponent implements ControlValueAccessor, OnDestroy {
    ...
    private _beforeChange: Subscription = new Subscription();
    ...
    constructor(
        ...
        this.color = 'rgb(0, 189, 99)';
        this.switchOffColor = '#80FFA2';
        this.switchColor = config && config.switchColor;
        this.defaultBgColor = '#00ACFF';
        this.defaultBoColor = '#476EFF';
    ...
    registerOnTouched(fn: (v: unknown) => void) {
